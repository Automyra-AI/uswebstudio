...
export default function ServicesHero() {
  return (
    <section className="relative overflow-hidden bg-navy-950 pt-36 pb-28 lg:pt-44 lg:pb-36">
      ...
      <div
        aria-hidden="true"
        className="pointer-events-none absolute -left-40 top-10 w-[700px] h-[700px] rounded-full animate-float-slow"
        style={{
          background:
      ...
      <div
        aria-hidden="true"
        className="pointer-events-none absolute -right-32 -bottom-40 w-[700px] h-[700px] rounded-full animate-float-slow-reverse"
        style={{
          background:
            "radial-gradient(circle, #e11d2a 0%, #5a0a12 40%, transparent 70%)",
          opacity: 0.55,
      ...
      <div
        aria-hidden="true"
        className="pointer-events-none absolute right-20 top-12 w-[420px] h-[420px] rounded-full bg-[#0e3a8a]/30 blur-2xl animate-pulse-slow"
      />
